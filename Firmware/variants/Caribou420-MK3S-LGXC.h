...
// Printer name
#define CUSTOM_MENDEL_NAME "Caribou420-MK3S-LGXC"
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {100,100,3200/8,410}
...
#define X_PROBE_OFFSET_FROM_EXTRUDER 22.25     // Z probe to nozzle X offset: -left  +right
#define Y_PROBE_OFFSET_FROM_EXTRUDER 11.5     // Z probe to nozzle Y offset: -front +behind
