...
create_multi_firmware()
{
 ...
 #           cp -f firmware.hex $SCRIPT_PATH/../$OUTPUT_FOLDER/$OUTPUT_FILENAME.hex
        	cp -f Firmware-intl.hex $SCRIPT_PATH/../$OUTPUT_FOLDER/FW$FW-$VARIANT-Build$BUILD-MULTI.hex || exit 34
            cp -f $BUILD_PATH/Firmware.ino.elf $SCRIPT_PATH/../$OUTPUT_FOLDER/FW$FW-$VARIANT-Build$BUILD-MULTI.elf
...
save_en_firmware()
{
        ...
        cp -f $BUILD_PATH/Firmware.ino.hex $SCRIPT_PATH/../$OUTPUT_FOLDER/$OUTPUT_FILENAME-EN.hex || failures 12
        echo "$(tput setaf 2)Copying English only elf file to PF-build-hex folder$(tput sgr 0)"
        cp -f $BUILD_PATH/Firmware.ino.elf $SCRIPT_PATH/../$OUTPUT_FOLDER/$OUTPUT_FILENAME-EN.elf || failures 12
    #fi
}
